...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="../../public/teste.css">
    ...
    <!-- Header End -->
        ...
        <div class="text-center" >
            ...
            <h1 class="mb-5">Materiais para estudo</h1>
        </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">LinkedIF</a>, Todos os direitos reservados.

                            Designed By <a class="border-bottom" href="materias_para_estudo.php">Gustavo de Souza, Keyla Rodrigues, Noemi Santos, Pedro Augusto, Riquele Maicana e Shayara Mary</a>
                        </div>
