...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="../../index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><img src="img/globo.png" height="60vw"> LinkedIF</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="cursos.php" class="nav-item nav-link active">Cursos</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center" >
                ...
                <h1 class="mb-5">Técnico em Agroecologia</h1>
            </div>
            <div>
                <h3>Na especificidade do curso, o profissional deverá ser capaz de atuar em sistemas de produção agropecuária e extrativista fundamentados em princípios agroecológicos; técnicas de sistemas orgânicos de produção com foco no desenvolvimento de ações integradas, unindo a preservação e conservação de recursos naturais à sustentabilidade social e econômica dos sistemas produtivos. O diferencial deste curso para o outro curso de agrária é que: a Agroecologia tem como foco a produção sustentável e sem uso de agrotóxicos, utilizando sistemas e recursos naturais para a produção de produtos.</h3>
            </div>
        </div>
    </div>
    <!-- Footer Start -->
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Designed By <a class="border-bottom" href="agroecologia.php">Gustavo de Souza, Keyla Rodrigues, Noemi Santos, Pedro Augusto, Riquele Maicana e Shayara Mary</a>
                    </div>
