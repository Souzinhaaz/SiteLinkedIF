...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="app/pages/login.php" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Entre aqui<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
                ...
                <div class="container">
                     <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            ...
                            <a href="app/pages/login.php" class="btn btn-light py-md-3 px-md-5 ">Entre Agora</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Conheça os Cursos Preparatórios Para o IF</h1>
                    <p class="mb-4">Oferecemos cursos de todas as matérias que são requisitadas na prova de admissão para o IF Baiano.</p>
                    <p class="mb-4">Dentre todos os recursos que disponibilizamos para os usuários sem conta, oferecemos suporte aos usuários cadastrados.</p>
                    <div class="row gy-2 gx-4 mb-4">
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Total Suporte</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Aulas Online</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Certificados Vitalícios</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>FAQ</p>
                        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center" >
                ...
                <h1 class="mb-5">Alunos Fundadores do Projeto</h1>
            </div>
            <div class="row g-4">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Designed By <a class="border-bottom" href="index.php">Gustavo de Souza, Keyla Rodrigues, Noemi Santos, Pedro Augusto, Riquele Maicana e Shayara Mary</a>
                    </div>
